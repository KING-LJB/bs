...
public interface FactoryService {
	...
	public void start(Serializable[] ids);                  //启用,参数ids表示可以同时启用多个对象
	public void stop(Serializable[] ids);                   //停用,参数ids表示可以同时停用多个对象
	
	
	public List<Factory> getFactoryList();                  //获取生产厂家的列表
}
