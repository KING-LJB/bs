...
<div class="PositionFrame_black" id="PositionFrame"></div>
	<div id="userInfo" style="z-index:999;" onclick="HideLoginDiv()" title="点击关闭">
		...
		您好：<strong>${NU_CURRENT_USER.username}</strong>&nbsp;&nbsp;|
		您的职位：<strong>${NU_CURRENT_USER.station}</strong>&nbsp;&nbsp;
	...
	<div class="top_logo">
	    <div class="navMenu"  style="float:left;text-align:left;">
	    		...
	    		<div style="height:29px;">
			    	...
			    	<div id="mask">
			    		<div id="menuContent">
 <c:if test="${NU_CURRENT_USER.station == '管理员'}"> 		
<span id="topmenu" onclick="top.location.href='fmain.action';linkHighlightMenu(this);">系统首页</span><span id="tm_separator"></span>
<span id="topmenu" onclick="top.leftFrame.location.href='cargoLeft1.action';top.main.location.href='cargoMain.action';linkHighlightMenu(this);">货运管理</span><span id="tm_separator"></span>
<span id="topmenu" onclick="top.leftFrame.location.href='statLeft.action';top.main.location.href='statMain.action';linkHighlightMenu(this);">统计分析</span><span id="tm_separator"></span>
<span id="topmenu" onclick="top.leftFrame.location.href='baseinfoLeft.action';top.main.location.href='baseinfoMain.action';linkHighlightMenu(this);">基础信息</span><span id="tm_separator"></span>
<span id="topmenu" onclick="top.leftFrame.location.href='sysadminLeft.action';top.main.location.href='sysadminMain.action';linkHighlightMenu(this);">系统管理</span></div>
</c:if>			

<c:if test="${NU_CURRENT_USER.station == '总经理'}"> 		
<span id="topmenu" onclick="top.location.href='fmain.action';linkHighlightMenu(this);">系统首页</span><span id="tm_separator"></span>
<span id="topmenu" onclick="top.leftFrame.location.href='statLeft.action';top.main.location.href='statMain.action';linkHighlightMenu(this);">统计分析</span><span id="tm_separator"></span>
</c:if>		

<c:if test="${NU_CURRENT_USER.station == '销售主管'}"> 		
<span id="topmenu" onclick="top.location.href='fmain.action';linkHighlightMenu(this);">系统首页</span><span id="tm_separator"></span>
<span id="topmenu" onclick="top.leftFrame.location.href='cargoLeft2.action';top.main.location.href='cargoMain.action';linkHighlightMenu(this);">货运管理</span><span id="tm_separator"></span>
<span id="topmenu" onclick="top.leftFrame.location.href='baseinfoLeft.action';top.main.location.href='baseinfoMain.action';linkHighlightMenu(this);">基础信息</span><span id="tm_separator"></span>
</c:if>	

<c:if test="${NU_CURRENT_USER.station == '运输主管'}"> 		
<span id="topmenu" onclick="top.location.href='fmain.action';linkHighlightMenu(this);">系统首页</span><span id="tm_separator"></span>
<span id="topmenu" onclick="top.leftFrame.location.href='cargoLeft3.action';top.main.location.href='cargoMain.action';linkHighlightMenu(this);">货运管理</span><span id="tm_separator"></span>
</c:if>	
