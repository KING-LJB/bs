    ...
    <div>
		<table class="commonTable" cellspacing="1">
	        <tr>
	            ...
	            <td class="tableContent"><input type="text" name="customName"></input></td>
	            <td class="columnTitle_mustbe">收购方：</td>
	            <td class="tableContent"><input type="text" name="offeror" value="商贸有限公司"></input></td>
	        </tr>
	        <tr>
	            <td class="columnTitle_mustbe">合同号：</td>
	            <td class="tableContent"><input type="text" name="contractNo"></input></td>
	            <td class="columnTitle_mustbe">打印版式：</td>
	            <td class="tableContentAuto">
	            	<input type="radio" name="printStyle" value="2" class="input" checked></input>两款
	            	<input type="radio" name="printStyle" value="1" class="input"></input>一款
	            </td>
	        </tr>
	        <tr>
	            ...
	            <td class="tableContentAuto">
	            	<input type="radio" name="importNum" value="3" class="input" checked></input>★★★
	            	<input type="radio" name="importNum" value="2" class="input"></input>★★
	            	<input type="radio" name="importNum" value="1" class="input"></input>★
	            </td>
	        </tr>
	        <tr>
	        ...
	        <tr>
	            ...
	            <td class="tableContent"><input type="text" name="tradeTerms"></input></td>
	            <td class="columnTitle_mustbe">验货员：</td>
	            <td class="tableContent"><input type="text" name="inspector"></input></td>
	        </tr>
	        <tr>
	            <td class="columnTitle_mustbe">制单人：</td>
	            <td class="tableContent"><input type="text" name="inputBy"></input></td>
	            <td class="columnTitle_mustbe">审单人：</td>
	            <td class="tableContent"><input type="text" name="checkBy"></input></td>
	        </tr>
	        <tr>
