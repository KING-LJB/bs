		...
		<table class="commonTable" cellspacing="1">
	        <tr>
	            ...
	            <td class="tableContent">
					<input type="text" style="width:90px;" name="inputDate" value="<fmt:formatDate value="${obj.inputDate}" pattern="yyyy-MM-dd HH:mm:ss"/>"
	             			onclick="WdatePicker({el:this,isShowOthers:true,dateFmt:'yyyy-MM-dd HH:mm:ss'});"></input>
				</td>
	        </tr>
	        <tr>
	            <td class="columnTitle_mustbe">信用证号：</td>
	            <td class="tableContent"><input type="text" name="lcno" value="${obj.lcno}"></input></td>
	            <td class="columnTitle_mustbe">收货人及地址：</td>
	            <td class="tableContent"><input type="text" name="consignee" value="${obj.consignee}"></input></td>
	        </tr>
	        
	         <tr>
	            <td class="columnTitle_mustbe">装运港：</td>
	            <td class="tableContent"><input type="text" name="shipmentPort" value="${obj.shipmentPort}"></input></td>
	            <td class="columnTitle_mustbe">目的港：</td>
	            <td class="tableContent"><input type="text" name="destinationPort" value="${obj.destinationPort}"></input></td>
	        </tr>
	        <tr>
	            <td class="columnTitle_mustbe">运输方式：</td>
	            <td class="tableContentAuto">
	            	<input type="radio" name="transportMode" value="SEA" class="input" <c:if test="${obj.transportMode=='SEA'}">checked</c:if>></input>SEA
	            	<input type="radio" name="transportMode" value="AIR" class="input" <c:if test="${obj.transportMode=='AIR'}">checked</c:if>></input>AIR
	            </td>
	            <td class="columnTitle_mustbe">价格条件：</td>
	            <td class="tableContentAuto">
	            	<input type="radio" name="priceCondition" value="FOB" class="input" <c:if test="${obj.priceCondition=='FOB'}">checked</c:if>></input>FOB
	            	<input type="radio" name="priceCondition" value="CIF" class="input" <c:if test="${obj.priceCondition=='CIF'}">checked</c:if>></input>CIF
	            </td>
	        </tr>
	        <tr>
...
<div class="listTablew">
		<table class="commonTable_main" cellSpacing="1" id="mRecordTable">
			<tr class="rowTitle" align="middle">
				...
				<td width="20">
					<input class="input" type="checkbox" name="ck_del" onclick="checkGroupBox(this);"></input>
				</td>
				<td width="33">序号</td>
				<td>货号</td>
				<td>数量</td>
