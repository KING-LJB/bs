    ...
    <script type="text/javascript">
    	...
    	*/
    	...
    	function sendMsg(){
	    	...
	    	var url = "http://localhost/bs/cxf/ExportServiceImpl";			//webService访问链接
	    	var requestBody = "<soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:q0=\"http://impl.service.bs.hncj.com/\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\">"
    ...
    <div>
		<table class="commonTable" cellspacing="1">
	        <tr>
	            ...
	            <td class="tableContent"><input type="text" name="id" id="id" value="1e09fd0e-a540-4cdd-a86f-778b205ddb92"></input></td>
	        </tr>
	        <tr>
